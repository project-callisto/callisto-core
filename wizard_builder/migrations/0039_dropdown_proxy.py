...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.TextField(choices=[('checkbox', 'checkbox'), ('dropdown', 'dropdown'), ('radiobutton', 'radiobutton'), ('singlelinetext', 'singlelinetext'), ('textarea', 'textarea')], default='singlelinetext', null=True),
        ),
    ]
