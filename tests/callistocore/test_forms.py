...
class SubmitToMatchingFormTest(TestCase):
    ...
    def test_accept_facebook_url(self):
        self.verify_url_works(
            'https://www.facebook.com/kelsey.gilmore.innis',
            'kelsey.gilmore.innis')

    def test_accept_partial_url(self):
        self.verify_url_works(
            'facebook.com/kelsey.gilmore.innis',
            'kelsey.gilmore.innis')
        self.verify_url_works(
            'www.facebook.com/kelsey.gilmore.innis',
            'kelsey.gilmore.innis')
        self.verify_url_works(
            'https://m.facebook.com/kelsey.gilmore.innis',
            'kelsey.gilmore.innis')

    def test_accept_with_querystring(self):
        self.verify_url_works(
            'https://www.facebook.com/kate.kirschner1?fref=nf',
            'kate.kirschner1')
        self.verify_url_works(
    ...
    def test_accept_posts_and_others(self):
        ...
        self.verify_url_works(
            ...
            'kelsey.gilmore.innis')
        self.verify_url_works(
            'https://www.facebook.com/jessica.h.ladd/music?pnref=lhc',
            'jessica.h.ladd')
