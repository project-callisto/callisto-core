...
EXAMPLE_FULL_DATASET = [{'answer': 'example data',
  'id': 1,
  'question_text': 'Write it down',
  'section': 2,
  'type': 'SingleLineText'},
 {'answer': '1',
  'choices': [{'choice_text': 'Within the last 5 days', 'id': 1},
 ...
 {'answer': 'example data',
  ...
  'type': 'Date'},
 {'answer': ['2', '16'],
  'choices': [{'choice_text': 'I have physical evidence - clothing, bedsheets, other objects with possible DNA',
    'id': 2},
  ...
  'type': 'Checkbox'},
 {'answer': '4',
  'choices': [{'choice_text': 'First choice', 'id': 4},
  ...
  'type': 'RadioButton'},
 {'answer': '15',
  'choices': [{'choice_text': 'Main (Lone Mountain)', 'id': 5},
 ...
 {'answers': [[{'answer': '1 example data',
    ...
    {'answer': '1 example data',
     ...
     'type': 'SingleLineText'},
    {'answer': '17',
     'choices': [{'choice_text': 'USF Undergraduate student', 'id': 3},
