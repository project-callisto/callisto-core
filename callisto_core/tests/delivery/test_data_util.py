...
class DataTransformationTest(TestCase):
    ...
    def test_single_line_text_form(self):
        data = RecordDataUtil.transform_if_old_format(record_data.EXAMPLE_SINGLE_LINE)
        self.assertEqual(
    ...
    def test_single_question_answers(self):
        data = RecordDataUtil.transform_if_old_format(record_data.EXAMPLE_SINGLE_RADIO)
        self.assertEqual(data["data"], record_data.EXPECTED_SINGLE_RADIO["data"])
    ...
    def test_new_data_not_transformed(self):
        data = RecordDataUtil.transform_if_old_format(record_data.EXPECTED_SINGLE_RADIO)
        self.assertEqual(data, record_data.EXPECTED_SINGLE_RADIO)
