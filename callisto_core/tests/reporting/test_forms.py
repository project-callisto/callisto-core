...
class MatchingRequiredFormTest(TestCase):
    ...
    def get_cleaned_identifier(self, url):
        form = MatchingRequiredForm({"facebook_identifier_0": url}, view=self.mock_view)
        self.assertTrue(form.is_valid())
        return next(iter(form.cleaned_data["identifiers"]))

    def get_twitter_cleaned_identifier(self, url):
        form = MatchingRequiredForm({"twitter_identifier_0": url}, view=self.mock_view)
        self.assertTrue(form.is_valid())
        return next(iter(form.cleaned_data["identifiers"]))
    ...
    def verify_twitter_url_works(self, url, expected_result):
        self.assertEqual(self.get_twitter_cleaned_identifier(url), expected_result)

    def verify_url_fails(self, url):
        form = MatchingRequiredForm({"facebook_identifier": url}, view=self.mock_view)
        self.assertFalse(form.is_valid())

    def verify_twitter_url_fails(self, url):
        form = MatchingRequiredForm({"twitter_identifier": url}, view=self.mock_view)
        self.assertFalse(form.is_valid())
...
class MatchingRequiredFormFacebookTest(MatchingRequiredFormTest):
    ...
    def test_accept_with_querystring(self):
        self.verify_url_works(
            "https://www.facebook.com/callistoorg?fref=nf", "callistoorg"
        )
        self.verify_url_works(
    ...
    def test_accept_posts_and_others(self):
        ...
        self.verify_url_works(
            "https://www.facebook.com/callistoorg/music?pnref=lhc", "callistoorg"
        )

    def test_accepts_old_profile_link(self):
        self.verify_url_works(
            "https://www.facebook.com/profile.php?id=100010279981469", "100010279981469"
        )
        self.verify_url_works(
...
class MatchingRequiredFormTwitterTest(MatchingRequiredFormTest):
    def test_accept_twitter_url(self):
        self.verify_twitter_url_works(
            "https://www.twitter.com/callisto_org", "twitter:callisto_org"
        )

    def test_accept_partial_url(self):
        self.verify_twitter_url_works(
            "twitter.com/callisto_org", "twitter:callisto_org"
        )
        self.verify_twitter_url_works(
            "www.twitter.com/callisto_org", "twitter:callisto_org"
        )
        self.verify_twitter_url_works(
            "https://mobile.twitter.com/callisto_org", "twitter:callisto_org"
        )

    def test_accept_with_querystring(self):
        self.verify_twitter_url_works(
            "https://twitter.com/callisto_org?some=query", "twitter:callisto_org"
        )
    ...
    def test_accept_tweets_and_others(self):
        ...
        self.verify_twitter_url_works(
            "https://twitter.com/callisto_org/following", "twitter:callisto_org"
        )
        self.verify_twitter_url_works(
            "https://twitter.com/callisto_org/media", "twitter:callisto_org"
        )
    ...
    def test_non_twitter_url_fails(self):
        ...
        self.verify_twitter_url_fails("https://www.twittr.com/callisto_org")
    ...
    def test_generic_url_fails(self):
        self.verify_twitter_url_fails("https://twitter.com/i/moments")
        self.verify_twitter_url_fails("https://support.twitter.com/")
        self.verify_twitter_url_fails("https://www.twitter.com/")
    ...
    def test_can_use_at_name(self):
        ...
        self.verify_twitter_url_fails("@callistoorgtoolong")
